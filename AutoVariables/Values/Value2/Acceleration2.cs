...
public class Acceleration2 : Value2 {
	...
	public static Force2 operator *(Acceleration2 left, Mass right) => new(left.value * right.value);

	public static Force2 operator *(Mass left, Acceleration2 right) => new(right.value * left.value);
